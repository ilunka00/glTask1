...
public:
	...
	Matrix& SetRotationZ(const GLfloat& angle);
	Matrix& SetRotationAngleAxis(float& angle, float& x, float& y, float& z);

	Matrix& SetScale(GLfloat& scale);
	Matrix& SetScale(const GLfloat& scaleX,const GLfloat& scaleY,const GLfloat& scaleZ);
	...
	Matrix& SetOrtho(const float& l,const float& r,const float& b,const float& t,const float& zn,const float& zf);
	Matrix Transpose();
